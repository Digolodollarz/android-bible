...
import tech.diggle.apps.bible.bhaibheridzvenemuchishona.home.HomeFragment;
...
public class MainActivity extends AppCompatActivity
        ...
        TestamentFragment.OnFragmentInteractionListener{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_devotional) {
            Timber.d("Devotional Fragment");
            fragment = new DevotionalFragment();
        } else if (id == R.id.nav_home) {
            Timber.d("Home Fragment");
        ...
        if (fragment != null) {
            getSupportFragmentManager()
                    ...
                    .commit();
            Timber.d("Devotional Fragment Loaded");
        }
